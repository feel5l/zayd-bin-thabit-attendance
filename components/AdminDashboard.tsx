...
import { AttendanceService, NOTIFICATION_EVENT, ATTENDANCE_UPDATE_EVENT, SCHEDULE_CHANGE_EVENT } from '../services/attendanceService';
...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  useEffect(() => {
    ...
    window.addEventListener(ATTENDANCE_UPDATE_EVENT, handleSubmissionsChange);
    ...
    return () => {
      ...
      window.removeEventListener(ATTENDANCE_UPDATE_EVENT, handleSubmissionsChange);
