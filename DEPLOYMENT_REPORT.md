...
### د) آخر تحقق إنتاج موثّق (سبتمبر ٢٠٢٦)

| البند | قيمة |
|-------|------|
| فرع / التزام | `main` @ `fa45302` (تجاهل `.env` / `.vercel` — PR #19؛ التوثيق اللاحق PR #20) |
| مثال نشر Vercel | `dpl_3LGGTxjpHExrRjdKbW2BWp7TdfiG` |
| تحقق المزامنة | معلم يعتمد غياباً → لوحة المدير `1 / 11` دون تحديث يدوي (poll ~8 ث) |
