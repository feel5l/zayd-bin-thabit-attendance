...
export const OFFICIAL_CLASSES_LIST: SchoolClass[] = [
  // الصف الثالث الابتدائي (3 فصول)
  {
    ...
    teacherName: 'أ. خالد محمد عمر الملا',
    attendancePeriod: 2,
  ...
  },
  {
    ...
    teacherName: 'أ. عبد العزيز إبراهيم الخلفان',
    attendancePeriod: 2,
    academicYear: '1447 - 1448 هـ'
  },
  {
    ...
    color: '#06b6d4',
    teacherId: 'teacher-7',
    teacherName: 'أ. محمد فهد عائض آل جحيش',
    attendancePeriod: 2,
    academicYear: '1447 - 1448 هـ'
  },
  ...
  // الصف الرابع الابتدائي (3 فصول)
  {
    ...
    teacherName: 'أ. نايف عبد اللطيف موسى الجغيمان',
    attendancePeriod: 2,
    academicYear: '1447 - 1448 هـ'
  },
  {
    ...
    teacherName: 'أ. محمد بن سلمان بن محمد الملحم',
    attendancePeriod: 2,
    academicYear: '1447 - 1448 هـ'
  },
  {
    ...
    teacherName: 'أ. عبد الله ماجد العرجاني',
    attendancePeriod: 2,
    academicYear: '1447 - 1448 هـ'
  },
  ...
  // الصف الخامس الابتدائي (3 فصول)
  {
    ...
    color: '#f59e0b',
    teacherId: 'teacher-5',
    teacherName: 'أ. صالح مسعود حمد الدوسري',
    attendancePeriod: 2,
    academicYear: '1447 - 1448 هـ'
  },
  {
    ...
    color: '#d97706',
    teacherId: 'teacher-9',
    teacherName: 'أ. عبد الرحمن محمد عبد الله القو',
    attendancePeriod: 2,
    academicYear: '1447 - 1448 هـ'
  },
  {
    ...
    color: '#b45309',
    teacherId: 'teacher-6',
    teacherName: 'أ. ناصر باتل محمد الدوسري',
    attendancePeriod: 2,
    academicYear: '1447 - 1448 هـ'
  },
  ...
  // الصف السادس الابتدائي (شعبتان)
  {
    ...
    color: '#8b5cf6',
    teacherId: 'teacher-8',
    teacherName: 'أ. حمد محمد عبيد المري',
    attendancePeriod: 2,
    academicYear: '1447 - 1448 هـ'
  },
  {
    ...
    teacherName: 'أ. عبد المحسن عبد الله طليحان الخالدي',
    attendancePeriod: 2,
    academicYear: '1447 - 1448 هـ'
  }
];
